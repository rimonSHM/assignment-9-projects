...
//     return (
//         <section className="py-24 bg-slate-50 relative w-full overflow-hidden rounded-3xl bg-[#16181d] border border-[#22252e] min-h-[520px] lg:min-h-[480px] flex items-center">
