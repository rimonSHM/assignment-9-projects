...
const MyTutors = () => {
  ...
  const fetchMyTutors = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/my-tutors`, {
        method: "GET",
        credentials: "include",
        cache: "no-store",
                headers: {
  ...
  const handleEdit = (tutor) => {
    setSelectedTutor({
      ...
      availableDaysAndTime: tutor.availableDaysAndTime || "",
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const updatedTutorPayload = {
        tutorName: selectedTutor.tutorName.trim(),
        photoURL: selectedTutor.photoURL.trim(),
        subjectCategory: selectedTutor.subjectCategory.trim(),
        availableDaysAndTime: selectedTutor.availableDaysAndTime.trim(),
        hourlyFee: Number(selectedTutor.hourlyFee),
        totalSlot: Number(selectedTutor.totalSlot),
        sessionStartDate: selectedTutor.sessionStartDate,
        institution: selectedTutor.institution?.trim() || "",
        location: selectedTutor.location?.trim() || "",
        teachingMode: selectedTutor.teachingMode || "Online",
        experience: selectedTutor.experience?.trim() || "",
      };
      ...
      alert("Something went wrong while updating tutor.");
    } finally {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      alert("Something went wrong while deleting tutor.");
    } finally {
    ...
    <>
      <div className="min-h-screen bg-black text-gray-100 pt-24 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-white">My Tutors</h1>
                    ...
                    {tutors.map((tutor) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-6 text-gray-400 text-sm">
                          ...
                          !isNaN(new Date(tutor.sessionStartDate).getTime())
                            ? new Date(
                                tutor.sessionStartDate
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  value={selectedTutor.subjectCategory}
                  onChange={handleChange}
                  required
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-500 text-black"
                >
              ...
              <div>
                ...
                <input
                  ...
                  value={selectedTutor.availableDaysAndTime}
                  onChange={handleChange}
                  required
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-500 text-black"
                />
              ...
              <div>
                ...
                <input
                  ...
                  value={selectedTutor.sessionStartDate}
                  onChange={handleChange}
                  required
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-500 text-black"
                />
